...
// Note: TestRequestPanel_MethodEditingVimKeys was removed because the old method
// dropdown editing mode (with j/k/l/h navigation) was replaced with inline method
// cycling (m/M keys). The new behavior is tested in TestRequestPanel_MethodEditing.
